...
//  Netflix-Clone
//
//  Created by Berk Canpolat on 9.02.2025.
//
...
class UpcomingTableViewCell: UITableViewCell {
    ...
    private func applyConstraints() {
        let titlePosterUIImageViewConst = [
            ...
            titlesPosterUIImageView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 0.5),
            titlesPosterUIImageView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -0.5),
            titlesPosterUIImageView.widthAnchor.constraint(equalToConstant: 100)
        ]
        
        let titleLabelViewConst = [
        ...
        NSLayoutConstraint.activate(titleLabelViewConst)
        NSLayoutConstraint.activate(playButtonConst)
    }
